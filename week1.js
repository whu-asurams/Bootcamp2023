...
week1[1][1] ='<u><b>Task 2:</b></u><br>'
    ...
    +'  See <a href="./CSS-properties-basic.txt" target="_blank">this file</a> for a list of style properties.'
    +'  <br>'
    +'  <br>'
    +'  <p>'
    +'        border <br>'
...
+'                        </p>'
+'                        <p>You can check here for the <a href="./myFramework-typography.txt" target="_blank">myFramework-typography.css file.</a>'
+'                          <br>'
...
+' <a href="./myFramework-container.txt"  target="_blank">myFramework-container.css</a>   '
...
+'    <br>'
+'    Open this file  '
+'<a href= "./myFramework-rowColumn.txt" target="_blank"> styles for row and column </a> '
+'and type into your "myFramework-rowColumn.css". '
+'Add the style file <i><a href="./myFramework-rowColumn.txt" target="_blank">myFramework-rowColumn.css</a></i> to your HTML file. '
...
+'</p>'
+'<p> Modify the style file <i><a href="./myFramework-typography.txt" target="_blank">myFramework-typography.css</a></i> and see what will happen to your HTML file. '
+'<br>Modify the style file <i><a href="./myFramework-container.txt" target="_blank">myFramework-container.css</a></i> and see what will happen to your HTML file. '
+'<br>Modify the style file <i><a href="./myFramework-rowColumn.txt" target="_blank">myFramework-rowColumn.css</a></i> and see what will happen to your HTML file. '
+'<br><br>';
...
+'  <a href="./myFramework-typography.txt" target="_blank">myFramework-typography.css</a>. '
...
+'<br>'
+'<p>Read the <i><a href="./myFramework-container.txt" target="_blank">myFramework-container.css</a></i> file and '
...
+'<br>Add the style file <i><a href="./myFramework-typography.txt" target="_blank">myFramework-typography.css</a></i> to your HTML file. '
+ '<br>Add the style file <i><a href="./myFramework-container.txt" target="_blank">myFramework-container.css</a></i> to your HTML file. '
...
+'<br>'
+'<p>Read the <i><a href="./myFramework-rowColumn.txt" target="_blank">myFramework-rowColumn.css</a></i> file and '
+'understand styles for row and columns. </p>'
+'<p>Add the style file <i><a href="./myFramework-rowColumn.txt" target="_blank">myFramework-rowColumn.css</a></i> to your HTML file. '
...
+'</p>'
+'<p> Modify the style file <i><a href="./myFramework-typography.txt" target="_blank">myFramework-typography.css</a></i>'
+' and see what will happen to your HTML file. '
+'<br>Modify the style file <i><a href="./myFramework-container.txt" target="_blank">myFramework-container.css</a></i> '
+' and see what will happen to your HTML file. '
+'<br>Modify the style file <i><a href="./myFramework-rowColumn.txt" target="_blank">myFramework-rowColumn.css</a></i> and'
...
+'         <a href="./myFramework-typography.css" target="_blank">myFramework-typography.css</a>. '
//+' code is <a href="./myFramework-typography.css" target="_blank"> myFramework-typography.css</a> <br>'
+'<br><br><br><br><br>';
...
//+' code is <a href="./example3a.txt" target="_blank"> example3a.txt</a> <br>'
+'      <br><br><b><u>CSS files</u></b><br>'
+'         <a href="./myFramework-container.css" target="_blank">myFramework-container.css</a>.<br>'
//+' code is <a href="./example3.css" target="_blank"> example3.css</a> <br>'
+'         <a href="./myFramework-rowColumn.css" target="_blank">myFramework-rowColumn.css.css</a>. '
//+' code is <a href="./myFramework-typography.css" target="_blank"> myFramework-typography.css</a> <br>'
+'<br><br><br><br><br><br>';
