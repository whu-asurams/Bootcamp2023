...
//    echo "Not yet";
   ...
   /* 
    if (!preg_match("/^[a-zA-Z ]+$/",$lastname)) {
        $lastname_error = "Last name must contain only alphabets and spaces";
    } else{
        $checkLastname = true;
    }
    
    if (!preg_match("/^[a-zA-Z ]+$/", $firstname)) {
        $firstname_error = "First name must contain only alphabets and spaces";
    ...
    */
 /*   
    if(!preg_match("/^[0-9]+$/",$age) || !(10 <= $age) ||  !($age <= 30)) {
        $age_error = "Must be number between 10 and 30";
    } else{
        $checkAge = true;
    }       
 */
 /*
    if(strlen($grade) ==0 ) {
        $grade_error = "Please choose a grade";
//        echo "grade";
    } else{
        $checkGrade = true;
    }
      ...
      <form action="register.php" method="post">
        ...
        <div class="row">
            ...
            <div class="col col-9">
                ...
                <span class="text-danger fs-2quarter">*<?php if (isset($lastname_error)) echo $lastname_error; ?></span>  <br>              
            </div>
        </div>    
        ...
        <div class="row">
            ...
            <div class="col col-9">
                ...
                <span class="text-danger fs-2quarter">*<?php if (isset($firstname_error)) echo $firstname_error; ?></span>  <br>              
            </div>
        </div>    
        ...
        <div class="row">
            ...
            <div class="col col-9">
                ...
                <span class="text-danger fs-2quarter">*<?php if (isset($email_error)) echo $email_error; ?></span>  <br>              
            </div>
        </div>    
        ...
        <div class="row">
            ...
            <div class="col col-9">
                ...
                <span class="text-danger fs-2quarter">*<?php if (isset($phone_error)) echo $phone_error; ?></span>  <br>              
            </div>
        </div>    
       ...
       <div class="row">
        ...
        <div class="row">
            ...
            <div class="col col-9">
                ...
                <span class="text-danger fs-2quarter"><?php if (isset($school_error)) echo $school_error; ?></span>  <br>              
            </div>
        </div>    
        ...
        <div class="row">
            ...
            <div class="col col-9">
                ...
                <span class="text-danger fs-2quarter"><?php if (isset($gender_error)) echo $gender_error; ?></span>  <br>              
            </div>
        </div>    
